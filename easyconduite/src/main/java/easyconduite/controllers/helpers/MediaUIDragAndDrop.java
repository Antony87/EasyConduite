 ...
 * @author antony
 */
public class MediaUIDragAndDrop {
    
    private static final Logger LOG = LogManager.getLogger(MediaUIDragAndDrop.class);
    
    public static void activateDrangAndDrop(FlowPane tableLayout){
